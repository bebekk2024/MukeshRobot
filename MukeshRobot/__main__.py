...
def Mukesh_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "mukesh_":
        ...
        [
        InlineKeyboardButton(text="ᴅᴇᴠ 👑", url=f"tg://user?id={5779185981}"),
        InlineKeyboardButton(text="ꜱᴜᴘᴘᴏʀᴛ ⚙️", url=f"tg://user?id={-1002127258037}"),
        ],
    [
        InlineKeyboardButton(
            text="➕ ᴛᴀᴍʙᴀʜᴋᴀɴ ɢᴡ ᴋᴇ ɢʀᴏᴜᴘ ʟᴜ ➕",
        ...
        query.message.edit_caption("**Dibawah ini beberapa jasa bot dan jajanan telegram dari [DISNEY STORE](https://t.me/Disney_storeDan).**"
...
Untuk List Userbot Premium DISNEY STORE bisa kalian cek list di bawah ini :
""",parse_mode=ParseMode.MARKDOWN,
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    InlineKeyboardButton(text="ᴜʙᴏᴛ ꜱᴘᴇꜱɪᴀʟ ɪɪɪ", url="https://t.me/WildanPrem_bot",
                    ),
                    InlineKeyboardButton(text="ᴜʙᴏᴛ ꜱᴘᴇꜱɪᴀʟ ɪᴠ", url="https://t.me/mhmdwldnnnn_bot",
                    ),
                    ],
                    [
                         InlineKeyboardButton(text="ᴜʙᴏᴛ ᴜʟᴛʀᴀ ɪ", url="https://t.me/WildanUltraPrem_bot"),
                         InlineKeyboardButton(text="ᴜʙᴏᴛ ᴜʟᴛʀᴀ ɪɪ", url="https://t.me/WildanUltraPrem_bot"),
                         InlineKeyboardButton(text="ᴜʙᴏᴛ ᴜʟᴛʀᴀ ɪɪɪ", url="https://t.me/WildanUltraPrem_bot"),
                    ],
                    [
                         InlineKeyboardButton(text="◁ ᴋᴇᴍʙᴀʟɪ", callback_data="mukesh_"),
                    ]
...
def Music_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "Music_":
        query.message.edit_caption(f"""
*Dibawah ini beberapa jasa bot dan jajanan telegram dari [DISNEY STORE](https://t.me/Disney_storeDan).
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 5779185981:
            update.effective_message.reply_text(
                ...
                f"\n\nʟᴜ ʙɪsᴀ ʟᴀɴɢsᴜɴɢ ᴘᴄ ᴋᴇ ɢᴡ ʏᴀ ᴋᴀʟᴏ ᴍᴀᴜ ᴅᴏɴᴀᴛᴇ ᴜᴀɴʜ ʟᴇʙɪʜ ʟᴜ ᴡᴋᴡᴋ : [ᴅᴀɴ](https://t.me/mhmdwldnnnn)",
                parse_mode=ParseMode.MARKDOWN,
...
def main():
                ...
                [
                    [
                        InlineKeyboardButton(
                            ...
                            url="https://t.me/musik_supportdan?startgroup=true"
                            )
                       ]
                ]
                     )
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.send_photo(
                f"@musik_supportdan",
                photo=f"https://telegra.ph//file/d0e9bcdae9083b897fced.jpg",
                caption=f"""
